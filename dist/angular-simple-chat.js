...
(function () {
    ...
    angular.module('angular-simple-chat.directives', []);
    angular.module('angular-simple-chat.directives')
        /**
         * @ngdoc object
    ...
    angular.module('angular-simple-chat.directives').directive('chatBubble', chatBubble);
    /* @ngInject */
    function chatBubble() {
        var directive = {
    ...
    angular.module('angular-simple-chat.directives').directive('messageComposer', messageComposer);
    /* @ngInject */
    ...
    angular.module('angular-simple-chat.directives').directive('simpleChat', simpleChat);
    /* @ngInject */
    ...
    angular.module('angular-simple-chat.directives').controller('simpleChatController', simpleChatController);
    /* @ngInject */
    ...
    angular.module('angular-simple-chat.directives').directive('voKeyUp', voKeyUp);
    /* @ngInject */
    ...
    angular.module("angular-simple-chat.directives").run(["$templateCache", function ($templateCache) {
        $templateCache.put("directives/chat-bubble/chat-bubble.html",
